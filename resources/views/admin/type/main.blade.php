    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">العناوين الرئيسية</li>
                    <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">الصفحة الرئيسة</a></li>
                </ol>
                </div><!-- /.col -->
                <div class="col-sm-6 text-end">
                  <h1 class="m-0">العناوين الرئيسية</h1>
                </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title float-end">جدول العناوين الرئيسية</h3>
                      <button type="button" data-bs-toggle="modal" data-bs-target="#addMainCat" class="btn btn-info">إضافة عنصر جديد</button>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <tbody>
                          @foreach ($mainCats as $cat)
                            <tr>
                              ...
                              <td>
                                <button type="button" data-bs-toggle="modal" data-bs-target="#deleteMainCat"class="btn-danger btn" title="delete" onclick="deleteMainItem({{$cat->id}})"><i class="fas fa-trash"></i></button>
                                <button class="btn-info btn edit" title="edit"  type="button" 
                                  ...
                                  data-bs-toggle="modal" data-bs-target="#editMainCat"><i class="fas fa-pen"></i></button>
                              </td>
                            </tr>
                          @endforeach
                        </tbody>
...
@section("scripts")
    ...
    <script>
      ...
      function deleteMainItem(id){
        ...
        $('#editMainCat-form-id').val(id)
        $('#editMainCat-form-name').val(name)
        $('#editMainCat-form-active').val(active)
        $('#editMainCat-form-image_meta').val(image_meta)
        $('#editMainCat-form-keywords').val(keywords)
        $('#editMainCat-form-description').val(description)
        $('#editMainCat-form-image').attr('src',image)
        })
    </script>
