    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">مقالات البلوغر</li>
        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title float-end">جدول المقالات الغير مفعلة</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                      ...
                      @foreach ($blogs as $blog)
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{url("admin/bloggers_blogs/{$blog->id}")}}" class="btn-info btn">عرض</a>
                            <a href="{{url("admin/bloggers_blogs/active/{$blog->id}")}}" class="btn-primary btn">تفعيل</a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title float-end">جدول المقالات   المفعلة</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table dir="rtl" id="example1" class="table table-bordered table-striped">
                      ...
                      @foreach ($Activeblogs as $blog)
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{url("admin/blogs/update/{$blog->id}")}}" class="btn-info btn"><i class="fas fa-pen"></i></a> --}}
                            <a href="{{url("admin/bloggers_blogs/{$blog->id}")}}" class="btn-info btn">عرض</a>
                            <a href="{{url("admin/bloggers_blogs/unactive/{$blog->id}")}}" class="btn-primary btn">إلغاء التفعيل</a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
          ...
          {{-- wnated to delte by blogger blog  --}}
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title float-end">جدول المقالات   التي يريد الكاتب حذفها</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table dir="rtl" id="example1" class="table table-bordered table-striped">
                      ...
                      @foreach ($deletedBlogs as $blog)
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{url("admin/blogs/update/{$blog->id}")}}" class="btn-info btn"><i class="fas fa-pen"></i></a> --}}
                            <a href="{{url("admin/bloggers_blogs/{$blog->id}")}}" class="btn-info btn">عرض</a>
                            <a href="{{url("admin/bloggers_blogs/delete/{$blog->id}")}}" class="btn-danger btn">قبول الحذف</a>
                            <a href="{{url("admin/bloggers_blogs/undelete/{$blog->id}")}}" class="btn-danger btn">رفض الحذف</a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
